...
function fetchData(){
    infoTxt.innerText = "Sonuçlar getiriliyor lütfen bekleyin ..."
...
function weatherDetails(info){
    if(info.cod == "404"){
        ...
        if(id==800){
            wIcon.src = "icons/clear.svg.png"
        }else if(id => 200 && id <= 232){
            wIcon.src = "icons/storm.svg.png"
        }else if(id => 600 && id <= 622){
            wIcon.src = "icons/snow.svg.png"
        }else if(id => 701 && id <= 781){
            wIcon.src = "icons/haze.svg.png"
        }else if(id => 801 && id <= 804){
            wIcon.src = "icons/cloud.svg.png"
        }else if(id => 300 && id <= 321 || (id => 500 && id <= 531)){
            wIcon.src = "icons/rain.svg.png"
        }
